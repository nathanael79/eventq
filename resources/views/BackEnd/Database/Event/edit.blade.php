            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary box-centered">
                        ...
                        <div class="box-body">
                            <form class="form-main form-update" action="{{ url('/admin/event/update/'.$event->id) }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Masukkan nama anda" value="{{ $event->name }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="address">Alamat / Address </label>
                                    <input type="text" class="form-control" name="address" id="address" placeholder="Masukkan alamat anda" value="{{ $event->address }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="text" class="form-control" name="email" id="email" placeholder="Masukkan email anda" value="{{ $event->price }}" min="1" required="">
                                </div>
                                <div class="form-group">
                                ...
                                <a href="{{ url('/admin/event/') }}" class="btn btn-lg btn-danger btn-flat"><i class="fa fa-trash-o"></i>&nbsp; Batal</a>
